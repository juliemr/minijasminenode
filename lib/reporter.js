...
TerminalReporter.prototype = {
  ...
  reportSpecResults: function(spec) {
    spec.finishTime = new Date().getTime() - this.startedAt.getTime();
    ...
    if (this.isVerbose_) {
      ...
      if (passed) {
        this.printLine_(this.stringWithColor_(this.indentMessage_(spec.description, indent), this.color_.pass()));
      } else {
        this.printLine_(this.stringWithColor_(this.indentMessage_(spec.description, indent), this.color_.fail()));
