...
var TerminalReporter = require('./reporters.js').TerminalReporter;
var RunnerEndCallback = require('./reporters.js').RunnerEndCallback;
...
exports.executeSpecs = function(options) {
  ...
  var runnerEndCallback = new RunnerEndCallback(onComplete);
  jasmine.getEnv().addReporter(runnerEndCallback);
  ...
  if (!options['isSilent']) {
    ...
    var terminalReporter = new TerminalReporter(reporterOptions);
